...
class CryptoEnv(gym.Env):
    ...
    def __init__(self, config, env_params, window_size=1, initial_capital=10000,
                 ...
                 print_verbosity=3, save_result=True, initial=True, 
    ...
    def step(self, actions):
        ...
        current_total_asset = self.total_asset 
        ...
        if done:
            ...
            self.episode_return = next_total_asset / self.initial_cash
        ...
        #       self.cash += price[index] * sell_num_shares * (1 - self.sell_cost_pct)
          ...
          # Reward function
          reward = delta_bot * self.norm_reward
    ...
    # self.data.close.values.tolist() == self.price_array[self.time]
    # self.data[tech].values.tolist() == tech_array
    # self.cash == self.initial_amount 
    # self.stocks == self.num_stocks
